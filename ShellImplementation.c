 ...
 */
 ...
 //ls > file.txt
void redirect(char** args){//output redirection

	// Open a file with fd no = 1
	pid_t pid = fork();
    int fd;
    int i,status;
...
//cat < file.txt
void redirect2(char** args){  //Input Redirection
...
int lsh_execute(char **args)
{
  ...
  int size  = 0;// strlen(args);//sizeof(args)/sizeof(char *);
